    ...
    <div className="min-h-screen bg-gradient-to-br from-dark-bg via-dark-surface to-dark-bg pb-24">
      ...
      <div className="px-2 -mt-4">
        <Tabs defaultValue="wallet" className="w-full max-w-full">
          <TabsList className="flex items-center justify-center w-full grid grid-cols-3 glassmorphic border border-eco-green/20 bg-dark-surface-variant/60 rounded-xl p-1 h-12 mx-0 mt-[11px] mb-[11px] gap-1">
            <TabsTrigger 
              value="wallet" 
              className="text-sm font-medium text-text-secondary data-[state=active]:text-text-primary data-[state=active]:bg-eco-green/20 rounded-lg transition-all duration-200 h-10 flex items-center justify-center flex-1"
            >
              Wallet
            </TabsTrigger>
            <TabsTrigger 
